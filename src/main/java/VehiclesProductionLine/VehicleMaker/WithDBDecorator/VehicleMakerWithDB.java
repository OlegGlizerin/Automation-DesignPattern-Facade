package VehiclesProductionLine.VehicleMaker.WithDBDecorator;

import VehiclesProductionLine.DBInteractionWithAdapter.DBManagers.DBMySQLManager;
import VehiclesProductionLine.DBInteractionWithAdapter.IDBMongo;
import VehiclesProductionLine.DBInteractionWithAdapter.MySQLToMongoDBAdapter.MySQLToMongoAdapter;
...
public class VehicleMakerWithDB extends VehicleMakerDecorator {
     ...
     * This pattern allows us to use the VehicleMakerWithDB without changing the VehicleMaker class, but to add the save to DB method.
